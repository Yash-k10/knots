...
class TestCommunicationHierarchy(unittest.TestCase):
    def test_student_permissions(self):
        # Student can message Faculty, Alumni
        ...
        # Student cannot message Dean, Principal, CEO, Central Admin
        self.assertFalse(validate_communication_hierarchy("Student", "Dean"))
        self.assertFalse(validate_communication_hierarchy("Student", "Principal"))
        self.assertFalse(validate_communication_hierarchy("Student", "CEO"))
        self.assertFalse(validate_communication_hierarchy("Student", "Central Admin"))

    def test_faculty_permissions(self):
        # Faculty can message Student, HOD, Controller, Alumni
        ...
        # Faculty cannot message CEO directly
        self.assertFalse(validate_communication_hierarchy("Faculty", "CEO"))

    def test_hod_permissions(self):
        # HOD can message Faculty, Controller, Alumni, TPO, Dean
        ...
        self.assertFalse(validate_communication_hierarchy("HOD", "CEO"))

    def test_controller_permissions(self):
        # Controller can message Faculty, HOD, Alumni
        ...
        self.assertFalse(validate_communication_hierarchy("Controller", "Student"))
        self.assertFalse(validate_communication_hierarchy("Controller", "CEO"))

    def test_alumni_permissions(self):
        # Alumni can message Student, Faculty, Controller, TPO
        ...
        self.assertFalse(validate_communication_hierarchy("Alumni", "Principal"))

    def test_tpo_permissions(self):
        # TPO can message Central Admin, Dean, Principal, Alumni, HOD
        ...
        self.assertFalse(validate_communication_hierarchy("TPO", "Student"))

    def test_dean_permissions(self):
        # Dean can message HOD, TPO, Principal, CEO
        ...
        self.assertFalse(validate_communication_hierarchy("Dean", "Student"))

    def test_principal_permissions(self):
        # Principal can message TPO, Dean, CEO
        ...
        self.assertFalse(validate_communication_hierarchy("Principal", "Student"))

    def test_ceo_permissions(self):
        # CEO can message Principal
        self.assertTrue(validate_communication_hierarchy("CEO", "Principal"))
        self.assertFalse(validate_communication_hierarchy("CEO", "Student"))
        self.assertFalse(validate_communication_hierarchy("CEO", "Faculty"))
