                ...
                >
                  ...
                  <div className="flex flex-row md:flex-col gap-2.5 flex-shrink-0 items-stretch md:items-end justify-end">
                    ...
                    <button
                      ...
                      className="flex-1 md:flex-none bg-slate-900 hover:bg-slate-800 text-indigo-400 border border-indigo-500/30 font-semibold px-4 py-2.5 rounded-xl text-xs transition-all flex items-center justify-center gap-1.5"
                    >
          ...
          {applications.length === 0 ? (
            ...
            <div className="space-y-3">
              {applications.map((app) => (
                <div
                  key={app.id}
                  className="bg-slate-950 border border-slate-800 rounded-xl p-5 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4"
                >
                  <div className="space-y-1">
                    <h4 className="text-base font-bold text-white">
                      Job Application #{app.job_posting_id}
                    </h4>
                    ...
                    {app.resume_url && (
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="text-xs text-indigo-400 underline hover:text-indigo-300 inline-block mt-1"
                      >
